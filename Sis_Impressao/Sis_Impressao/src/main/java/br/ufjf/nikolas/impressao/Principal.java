...
public class Principal {
    ...
    /**
     * Leitura dos dados do secretario
     * @return aluno
    ...
    /**
     * Contem o menu principal do programa
     * @throws ParseException
     */
        ...
        while(sair == false)
        {
            ...
            switch (opcao)
            {
                ...
                case 4:
                    ...
                    if(!s2.equals("")) //verifica se ha aluno para mostrar a lista
                    {
                ...
                case 5:
                    ...
                    if(!s22.equals("")) //verifica se ha professor para mostrar a lista
                    {
